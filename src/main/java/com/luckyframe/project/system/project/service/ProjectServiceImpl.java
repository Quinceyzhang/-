...
/*		for(String projectIdStr:projectIds){
		...
		for(String projectIdStr:projectIds){
			int projectId=Integer.parseInt(projectIdStr);
			projectMapper.deleteEquipmentsByProjectId(projectId);
			projectMapper.deletePlanByProjectId(projectId);}
	...
	@Override
	public List<ProjectEquipments> selectEquipmentsByProjectId(int projectId) {
		
		return projectMapper.selectEquipmentsByProjectId(projectId);
	}

	@Override
	public int deleteProjectEquipmentsByIds(ProjectEquipments equipment) {
		int projectId=equipment.getProjectId();
		return projectMapper.deleteEquipmentsByProjectId(projectId);
		
	}

	@Override
	public int insertProjectEquipments(ProjectEquipments equipments) {
	    return projectMapper.insertProjectEquipments(equipments);
	}

	@Override
	public List<ProjectPlan> selectProjectPlanList(Integer projectId) {
		return projectMapper.selectProjectPlanList(projectId);
	}

	@Override
	public void deletePlanByProjectId(Integer projectId) {
		projectMapper.deletePlanByProjectId(projectId);
		
	}

	@Override
	public int insertPlan(Map<String, Integer> plan) {
		projectMapper.insertPlan(plan);
		return 1;
	}

	@Override
	public List<ProjectPlan> selectPlanList(Integer projectId) {
		return projectMapper.selectPlanList(projectId);
	}

	@Override
	public List<Map> selectProjectByMonth() {
		// TODO Auto-generated method stub
		return projectMapper.selectProjectByMonth();
	}
	@Override
	public List<Map> selectSuccessProjectByMonth() {
		// TODO Auto-generated method stub
		return projectMapper.selectSuccessProjectByMonth();
	}
	@Override
	public List<Map> selectFailProjectByMonth() {
		// TODO Auto-generated method stub
		return projectMapper.selectFailProjectByMonth();
	}

	@Override
	public List<Map> selectPostByName() {
		// TODO Auto-generated method stub
		return projectMapper.selectPostByName();
	}

	@Override
	public void saveResult(Integer projectId) {
		List<Map> mapList = projectMapper.selectResult(projectId);
		...
		for(Map result:mapList){
			if("0".equals((result.get("isQualified")).toString())){
				map.put("isQualified", "0");
				break;
			}
		}
		
		projectMapper.saveResult(map);
		
	}

	@Override
	public Integer searchNewId() {
		// TODO Auto-generated method stub
		return projectMapper.searchNewId().get("projectId");
	}

	@Override
	public int updateProjectEquipments(ProjectEquipments equipment) {
		projectMapper.updateProjectEquipments(equipment);
		return 1;
	}

	@Override
	public List<Map<String, Integer>> selectPlanIdByProjectId(Integer projectId) {
		return projectMapper.selectPlanIdByProjectId(projectId);
	}
}
