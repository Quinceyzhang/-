...
/*	@Override
	...
	public int deleteProjectPlanByIds(String ids)
	{
		...
		for(String planIdStr:planIds){
			...
			Long planId1 = Long.parseLong(planIdStr); 
/*			ProjectPlan ProjectPlan = projectPlanMapper.selectProjectPlanById(planId);
			...
			projectPlanMapper.deleteTestCaseByPlanId(planId1);
    ...
    @Override
	public List<ProjectPlan> selectProjectPlanAll(Integer projectPlanId) {
		
		List<ProjectPlan> projectPlanList= selectProjectPlanList(new ProjectPlan());
        return projectPlanList;
	}

	@Override
	public List<TestCaseTime> selectTestCaseList(Integer planId) {
		return projectPlanMapper.selectTestCaseByPlanId(planId);
	}

	@Override
	public void deleteTestCaseByPlanId(long planId) {
		projectPlanMapper.deleteTestCaseByPlanId(planId);
	}

	@Override
	public int insertTestCase(Map<String, Long> testCase) {
		projectPlanMapper.insertTestCase(testCase);
		return 1;
	}

	@Override
	public List<TestCase> selectTestCaseForPlan(Long planId) {
		// TODO Auto-generated method stub
		return projectPlanMapper.selectTestCaseForPlan(planId);
	}
	...
	public int isOccupy(String ids) {
		...
		for(String planId:planIds){
			occupy = occupy + Integer.parseInt(projectPlanMapper.planIsOccupy(planId).get("count"));
		}
		return occupy;
	}
